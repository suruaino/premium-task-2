    ...
    return (
        <header className="w-full max-w-[85%] md:max-w-[1160px] h-20 flex justify-end items-center border">
          <div className="theme-toggle-box flex gap-2">
            ...
            />
            <div onClick={toggleTheme} className="theme-toggle bg-white w-10 h-5 px-1 flex items-center rounded-full">
              {/* <input type="checkbox" /> */}
              <div className="w-4 h-4 bg-black z-50 rounded-full"></div>
